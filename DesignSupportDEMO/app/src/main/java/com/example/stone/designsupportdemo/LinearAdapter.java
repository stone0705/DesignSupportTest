    ...
    public void onBindViewHolder(final LinearViewHolder viewHolder, int i) {
        ...
        viewHolder.card.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                View shareView = viewHolder.image;
                intent.setClass(mContext,DetailActivity.class);
                ActivityOptions transitionActivityOptions = ActivityOptions.makeSceneTransitionAnimation(mActivity, shareView, "image");
